...
def get_args():
    ...
    parser.add_argument('--env', type=str, default='ErgoPusher', help='the number of epochs to train the agent')
    ...
    parser.add_argument('--variant', type=str, default='10', help='the number of epochs to train the agent')
