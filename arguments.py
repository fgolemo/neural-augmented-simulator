...
def get_args():
    ...
    parser.add_argument('--env-name', type=str, default='ErgoReacher-Headless-MultiGoal-Halfdisk-Long-v2',
                        help='the environment name')
    parser.add_argument('--variant', type=str, default='01',
                        help='type of variant')
    parser.add_argument('--approach', type=str, default='motor-babbling',
                        help='this can be either motor babbling or goal babbling')
    parser.add_argument('--seed', type=int, default=1,
                        help='random seed')
    parser.add_argument('--noise-type', type=str, default='action_noise',
                        help='random seed')
